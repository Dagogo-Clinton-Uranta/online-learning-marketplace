 ...
 /*video manipulation logic */
  ...
  Conditions générales d'utilisationEn vigueur le 17/01/2022Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des  modalités  de  mise  à  disposition  du  site  et  des  services  par  BONECOLE  INC   et  de  définir  les conditions d’accès et d’utilisation des services par « l'Utilisateur ».Les présentes CGU sont accessibles sur le site à la rubrique «CGU».Toute  inscription  ou  utilisation  du  site  implique  l'acceptation  sans  aucune  réserve  ni  restriction  des présentes CGU par l’utilisateur. Lors de l'inscription sur le site via le Formulaire d’inscription, chaque utilisateur accepte expressément les présentes CGU en cochant la case précédant le texte suivant : « Je reconnais avoir lu et compris les CGU et je les accepte ».En cas de non-acceptation des CGU stipulées dans le présent contrat, l'Utilisateur se doit de renoncer à l'accès des services proposés par le site.BONECOLE INC. SARLU se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.
    ...
    ARTICLE 1 : Les mentions légales
     ...
     L'édition du site www.bonecole.com est assurée par la Société BONECOLE INC SARLU au capital de 10,000,000 GNF, immatriculée au RCCM sous le numéro GN.TCC.2021.B.13811, dont le siège social est situé à Immeuble BSIC, Lambanyi Marché, Commune de Ratoma, Conakry, République de Guinée.Numéro de téléphone : +224611238888Adresse e-mail : contact@bonecole.comL'hébergeur du site www.bonecole.com est la société BONECOLE INC SARLU, dont le siège social est  situé  à  Immeuble  BSIC,  Lambanyi  marché,  Commune  de  Ratoma,  Conakry,  République  de Guinée, avec le numéro de téléphone : +224611238888.
     </p>
    ...
    ARTICLE 3 : Collecte des données
     ...
     Le  site  fait  l’objet  de  collecte  de  données  concernant  les  Utilisateurs.  Ces  données  concernent  les informations personnelles et la navigation sur le site www.bonecole.com. Les données personnelles sont: adresse e-mail, nom, école d’origine, classe, identifiant Facebook et numéro de téléphone. Soit les   données   de   navigation   concernent   strictement   les   activités   de   l’utilisateur   sur   le   site  www.bonecole.com
     </p>
    ...
    ARTICLE 5 : Responsabilité
     ...
     Les sources des informations diffusées sur le site  www.bonecole.com sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site  www.bonecole.com ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.L'Utilisateur s'assure de garder son mot de passe secret. Toute divulgation du mot de passe, quelle que  soit  sa  forme,  est  interdite.  Il  assume  les  risques  liés  à  l'utilisation  de  son  identifiant  et  mot  de passe. Le site décline toute responsabilité.Le  site  www.bonecole.com  ne  peut  être  tenu  pour  responsable  d’éventuels  virus  qui  pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.La  responsabilité  du  site  ne  peut  être  engagée  en  cas  de  force  majeure  ou  du  fait  imprévisible  et insurmontable d'un tiers.
     </p>
    ...
    ARTICLE 6 : Liens hypertextes
     ...
     Des liens hypertextes peuvent être présents sur le site. L'utilisateur est informé qu’en cliquant sur ces liens,  il  sortira  du  site  www.bonecole.com.  Ce  dernier  n’a  pas  de  contrôle  sur  les  pages  web  sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.
     </p>
