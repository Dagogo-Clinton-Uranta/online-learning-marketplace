...
import { fetchEmployeer, fetchGroupMembers } from 'src/redux/actions/main.action';
...
export default function VideoDetailsPage() {
  ...
  const { groupMembers, employeer, isLoading } = useSelector((state) => state.main);
  ...
  return (
    <>
      <Helmet>
        <title> Bonecole| VIDEO-DETAILS </title>
      </Helmet>
