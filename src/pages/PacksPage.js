...
function PacksPage() {
  ...
  const titleToCourses = {
    "Pack TSS": ['1', '2', '3', '4', '5', '6', '7'],
    "Pack TSM": ['1', '8', '9', '3', '6', '10', '11'],
    "Pack TSE": ['1', '8', '16', '6', '10', '11', '12', '13'],
    "PACK 10eme": ['14', '15', '16', '17', '18', '23', '19', '20'],
    "Pack 6eme": ['21', '22', '23', '24', '25', '26'],
  };
  ...
  My Courses
        ...
        <Grid container spacing={2}>
          ...
          >
            {topics
              .filter((topic) => topic.title.toLowerCase().includes('pack'))
              .map((topic, i) => {
                // Check if the title exists in the mapping
                const courses = titleToCourses[topic.title] || [];
                ...
                return (
                  ...
                  >
                    <SampleCardPage
                      ...
                      title={topic.title}
                      image={
                        topic.subjectImageUrl && topic.subjectImageUrl.length > 1
