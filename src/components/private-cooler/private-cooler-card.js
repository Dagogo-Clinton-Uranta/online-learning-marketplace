...
function PrivateCoolerCard ({ groupId, groupPin, name, fee, count, status, img, startDate, isMember }) {
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm container spacing={2}>
              ...
              onClick={() => {
                const groupData = {groupId, groupPin, name, fee, count, img, startDate}
                navigate('/dashboard/join-private-cooler', { state: { groupData } })
              }}>
                {status}
            </Button>
              }
...
export default PrivateCoolerCard