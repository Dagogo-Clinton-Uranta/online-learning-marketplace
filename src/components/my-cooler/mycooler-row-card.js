...
function MyCoolerRowCard ({ name, email, joined, status}) {
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm container spacing={2}>
              ...
              <Button variant="contained" style={{minHeight: '45px', minWidth: '145px', backgroundColor: status === 'Paid' ? 'green' : 'red', }}>
                {status}
            </Button>
              </Grid>
              </Grid>
...
export default MyCoolerRowCard